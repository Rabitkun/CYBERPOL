...
urlpatterns += [
    ...
    path('get_vm_status_rest/', rest.get_vm_status, name='get_vm_status_rest'),
    ...
    path('get_refs_list_rest/', rest.get_references_list, name='get_refs_list_rest'),
    path('get_icons_list_rest/', rest.get_icons_list, name='get_icons_list_rest'),
]